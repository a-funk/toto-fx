...
/**
 * Create an isolated StateStore instance.
 * Each engine gets its own store -- no cross-engine state collisions.
 * @returns {Object} StateStore instance
 */
...
/** @deprecated Use createStateStore() for isolated instances. Kept for backwards compatibility. */
